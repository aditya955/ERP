          ...
          <div className="student-info">
            <DataContainer title="Student's Details">
              ...
              <div className="user-data">
                ...
                <p>
                  {" "}
                  <b>Registration Number</b>: {props.regNo}{" "}
                </p>
              </div>
            </DataContainer>
            <DataContainer title={"Academic Details"}>
              <div className="other-user-data">
                ...
                <p>
                  {" "}
                  <b>Department</b>: {props.dept}{" "}
                </p>
                <p>
                  {" "}
                  <b>Acad Year</b>: {props.acadYear}{" "}
                </p>
                <p>
                  {" "}
                  <b>Acad Term</b>: {props.acadTerm}{" "}
                </p>
              </div>
            </DataContainer>
            <DataContainer title={"Wi-Fi Details"}>
              ...
              <p>
                {" "}
                <b>Username</b>: {props.wifiUsername}{" "}
              </p>
              <p>
                {" "}
                <b>Password</b>: {props.wifiPassword}{" "}
              </p>
            </DataContainer>
          </div>
        </div>
          ...
          <DataContainer title="Re-dmission Status">
            <div className="readmission-status">
              ...
              <h3>
                ...
                <span
                  style={
                    props.readmissionStatus.toLowerCase() === "yes"
                      ? { color: "green" }
                      : { color: "red" }
                  }
                >
                  {props.readmissionStatus}
                </span>{" "}
              </h3>
              <h3>
                {" "}
                Section / Roll No. : {props.section} / {props.rollNo}{" "}
              </h3>
            </div>
          </DataContainer>
